...
const projectSchema = new mongoose.Schema({
  ...
  demo: { type: String, default: "", trim: true }, preview: { type: String, default: "", trim: true }, previews: { type: [String], default: [] }, previewVariants: { type: [String], default: [] }, code: { type: String, default: "", trim: true }, pattern: { type: String, enum: ["pattern-1", "pattern-2", "pattern-3"], required: true },
